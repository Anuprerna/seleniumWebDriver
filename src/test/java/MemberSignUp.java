...
public class MemberSignUp {
	...
	public static void main(String[] args) throws InterruptedException  {
		...
		System.out.println("Test Case 1 :Get started is Not present -Test Case Failed"); 
		} 
		Thread.sleep(7000);
		...
		memberemail.sendKeys("amit.test11email@biyac.com"); 
		Thread.sleep(1500); 
		memberemail.clear(); 
...
*/
		...
		lastname.sendKeys("Doe"); 
		Thread.sleep(1500); 
		memberemail.sendKeys("amit.test11email@bn.com"); 
		Thread.sleep(1500); 
		phonenumber.sendKeys("6468953210"); 
		Thread.sleep(1500); 
		//timezone.click(); 
