...
public class FindDoctorandjoinlinks {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String LoginpageexpectedURL=("https://www.lemniska.com/login?ReturnUrl=%2fappointment%3fDoctorName%3dDr.-Harjap-Nanva%26ProviderId%3d60440cc2-58a0-4c0e-bdd6-a97df3321f81&DoctorName=Dr.-Harjap-Nanva&ProviderId=60440cc2-58a0-4c0e-bdd6-a97df3321f81");																																												
		...
		Thread.sleep(2000);																																												
		String Location=VG.findElement(By.xpath("//p[contains(text(),'902 S. Airport Dr. ,Suite 2 ,78596')]")).getText();																																												
		...
		String harjapnamevewporfilepage=VG.findElement(By.xpath("//h2[contains(text(),'Dr. Harjap Nanva')]")).getText();																																												
		...
		loginemail.sendKeys("wj916137@gmail.com");																																												
		Thread.sleep(1500);																																												
		WebElement loginPW=VG.findElement(By.xpath("//input[@id='Password']"));																																												
		loginPW.sendKeys("amit@626");																																												
		Thread.sleep(1500);																																												
		...
		//to go to Manage appointment																																												
			VG.findElement(By.xpath("//*[@id=\"dropdownMenuLink\"]")).click();																																											
			Thread.sleep(1000);																																											
																																														
			VG.findElement(By.partialLinkText("Dashboa")).click();																																											
			Thread.sleep(1500);																																											
////////////////////////////////////////////																																														
		...
		Thread.sleep(2500);																																												
		Docsearch11.sendKeys("Harjap");																																												
		Thread.sleep(1500);																																												
		WebElement searchicon11=VG.findElement(By.xpath("//button[@id='btn-search']"));																																												
		Thread.sleep(2500);																																												
		searchicon11.click();																																												
		Thread.sleep(5500);																																												
		System.out.println("Test Case 22 : Harjap sir is Searched on the Find Doctor page");																																												
		Thread.sleep(2500);																																												
